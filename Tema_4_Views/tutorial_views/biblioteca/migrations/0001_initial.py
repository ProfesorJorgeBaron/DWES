# Generated by Django 3.2.22 on 2023-10-10 20:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idiomas', models.CharField(choices=[('ES', 'Español'), ('EN', 'Inglés'), ('FR', 'Francés'), ('IT', 'Italiano')], default='ES', max_length=2)),
        ...
        migrations.AddField(
            model_name='cliente',
            name='libros',
            field=models.ManyToManyField(through='biblioteca.Prestamo', to='biblioteca.Libro'),
        ),
    ]
